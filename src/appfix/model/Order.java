...
public class Order {
	...
	public Order(quickfix.fix42.NewOrderSingle message) {order = OrderConverter.converter(this, message);}
	
	public Order(quickfix.fix44.NewOrderSingle message) {order = OrderConverter.converter(this, message);}
	
	public Order(quickfix.fix50.NewOrderSingle message) {order = OrderConverter.converter(this, message);}
